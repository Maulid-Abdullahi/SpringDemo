package spring.training.demo.config;
...
@ComponentScan("spring.training.demo.datastore")
@EnableJpaRepositories(basePackages = "spring.training.demo.datastore.dao")
public class PersistenceCMTConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
        ...
        em.setPackagesToScan("spring.training.demo.datastore.model");
